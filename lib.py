...
add_status('updates', 'Fedora 22', 'firewalld', DEFAULT)
add_status('updates', 'Fedora 23', 'firewalld', DEFAULT)
add_status('updates', 'Fedora 24', 'firewalld', DEFAULT)
...
add_status('nx', 'Fedora 22', 'firewalld', DEFAULT)
add_status('nx', 'Fedora 23', 'firewalld', DEFAULT)
add_status('nx', 'Fedora 24', 'firewalld', DEFAULT)
...
add_status('pie', 'Fedora 22', 'firewalld', DEFAULT)
add_status('pie', 'Fedora 23', 'firewalld', DEFAULT)
add_status('pie', 'Fedora 24', 'firewalld', DEFAULT)
...
add_status('stack-aslr', 'Fedora 22', 'firewalld', DEFAULT)
add_status('stack-aslr', 'Fedora 23', 'firewalld', DEFAULT)
add_status('stack-aslr', 'Fedora 24', 'firewalld', DEFAULT)
